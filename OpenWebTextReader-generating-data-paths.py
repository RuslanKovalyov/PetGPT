...
print("Example path: /Users/ruslan/Downloads/training-data/shakespeare/")
path = input("Enter path to dataset for generating paths.txt: ")
...
# remove folder with name splited
folders = [folder for folder in folders if not folder.startswith('splited')]
